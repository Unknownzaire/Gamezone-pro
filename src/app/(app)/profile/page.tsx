...
const SocialIcon = ({ name, icon, url }: { name: string; icon: SocialLink['icon']; url:string }) => {
    ...
    switch (icon) {
        ...
        case 'instagram':
            socialIcon = (
                 <svg {...iconProps} viewBox="0 0 32 32">
                    <radialGradient id="ig-grad" cx="25.666" cy="7.102" r="28.995" gradientUnits="userSpaceOnUse">
                        <stop offset=".001" stop-color="#fd5"></stop>
        ...
        case 'telegram':
             socialIcon = (
                <svg {...iconProps} fill="#2AABEE" viewBox="0 0 24 24"><path d="m9.417 15.181-.397 5.584c.568 0 .814-.244 1.109-.537l2.663-2.545 5.518 4.041c1.012.564 1.725.267 1.998-.931l3.622-16.972.001-.001c.321-1.496-.541-2.081-1.527-1.714l-21.29 8.151c-1.453.564-1.431 1.374-.247 1.741l5.443 1.693L18.953 5.78c.595-.394 1.136-.176.691.218z"></path></svg>
            );
            break;
        case 'whatsapp':
            socialIcon = (
